...
def get_grade_en_cours(texte,ordre): # sert uniquement à mettre en gras le bouton concerné
    ...
    if ordre == "AL":
        rangs_precedents = {
            ...
            13 : max(texte.rfind("au grade d'officier"),texte.rfind("au grade d’officier"),texte.rfind("au grade d'officière ou d'officier"),texte.rfind("au grade d’officière ou d’officier")),
